...
class TarjetaTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testViaje(){
  	$this->tarjeta->recargar(272);
  	$this->tarjeta->pagar($this->colectivoA, "2016/06/30 22:50");
  	$this->assertEquals($this->tarjeta->viajes["2016/06/30 22:50"]->getTipo(),"Viaje en Colectivo", "");
  	$this->assertEquals($this->tarjeta->viajes["2016/06/30 22:50"]->getHorario(),"2016/06/30 22:50", "");
  	$this->assertEquals($this->tarjeta->viajes["2016/06/30 22:50"]->getCosto(),8, "");
  	$this->assertEquals($this->tarjeta->viajes["2016/06/30 22:50"]->getTransporte()->getNombreEmpresa(),"Rosario Bus", "");
  }
